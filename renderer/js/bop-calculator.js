            ...
            <div class="sample-row" data-row-id="${newRowId}">
                <div class="sample-inputs">
                    <div class="sample-input">
                        ...
                        <input type="number" class="ballast-input" placeholder="0-1000" min="0" max="1000">
                    </div>
                    <div class="sample-input">
                        <label>Restrictor (mm):</label>
                        <input type="number" class="restrictor-input" placeholder="0-100" min="0" max="100" step="1">
                    </div>
